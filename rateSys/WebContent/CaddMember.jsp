...
// 						for(var i = 0; i < pageBean.group.length; i++) 
// 							options += "<option value='" + pageBean.group[i].pspgid + "'>" + pageBean.group[i].spgname + "</option>";		
// 						$("select").html(options);
		...
		<div class="main">
			...
			<div class="left">
				...
				<ul>
					...
					<a href="CaddMember.jsp"><li class="now"><img src="images/left6-s.png">添加专家组成员</li></a>
