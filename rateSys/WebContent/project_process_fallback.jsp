...
<!-- 					<a href="changeSubPin.jsp"><li><img src="images/left2.png">下级密码</li></a> -->
					...
					<a href="project_process_fallback.jsp"><li class='now'><img src="images/left9-s.png">项目流程回退</li></a>
...
<!-- 							<li>123</li><li>123</li><li>123</li>  -->
						...
						<li>项目截止时间：<input readonly="readonly" onClick="WdatePicker({dateFmt:'yyyy-MM-dd'})"   autocomplete="off" name="txt2" id="txt2" type="text" style="z-index:55;border: #dedede solid 0.1rem;background-color:#f4f4f4;width: 300px;height:3.5rem" class="Wdate" /></li>
						...
						<li style='margin-left: 3rem;'>上级流程：<input name="txt4" id="txt4" type="text" /></li>
					</ul>
				...
				<table>
					<tr>
						<th class="t1">项目名称</th>
						<th class="t2" style="display:none">项目截止时间</th>
						<th class="t3" style="display:none">项目流程</th>
						<th class="t4">当前流程</th>
						<th class="t5">操作人员</th>
						<th class="t6">完成情况</th>
						<th class="t7">上级流程</th>
