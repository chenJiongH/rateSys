		...
		<div class="main">
			...
			<div class="left">
				...
				<ul>
					...
					<a href="Dplace-on-file.jsp"><li class="now"><img src="images/left9-s.png">项目评分详情</li></a>
...
<!-- 				用于下载总评或附件 -->
				...
				<form id='form1' method='post' action='PlaceOnFileServlet/rate' enctype="multipart/form-data">
					<span class="breakH" style='top: 125px;margin-left: 85px;width: 451px;'></span>
					<span class="breakV" style='top: 100px;margin-left:-102px;'></span>
			...
			<!-- 			编辑框 -->
				...
				<div class="pagediv">
					...
					<div id='tdiv' class='tdiv' style='width: 956px;'>
					<table style='    width: 942px;'>
  						<tr id='row1'>
							...
							<th class='t8' style='text-indent:-187px;background-color: rgb(236, 239, 253);z-index:2000;' >县级专家</th>
					...
					<!-- 自定义滚动条
					<div class="bottom-bar" style="width:58.6rem;left: 45.5rem;top: 63rem">
		                <span></span>
		            </div> -->
				</div>
			</div>
