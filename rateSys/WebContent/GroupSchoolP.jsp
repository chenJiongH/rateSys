...
<html>
	...
	// 						"background-color": "white",
				...
				//给专家组下拉框 绑定 内容改变事件，同步获取左表格该专家组所分配学校，右表格可以不刷新 仍然为当前项目剩余学校 (除非是省级管理员，因为一个项目可以有两个级别。级别不同，即使项目相同，但是分配的学校得区分开)
...
<!-- 					<a href="changeSubPin.jsp"><li><img src="images/left2.png">下级密码</li></a> -->
					...
					<a href="GroupSchoolP.jsp"><li class="now"><img src="images/left7-s.png">专家组学校任务</li></a>
