		...
		<div class="main">
			...
			<div class="left">
				...
				<ul>
					...
					<a href="DexInfoM.jsp"><li class="now"><img src="images/left3-s.png">专家信息</li></a>
					<br>
...
<!-- 							<li>123</li><li>123</li><li>123</li>  -->
					...
					<input style='    position: absolute;    left: 9%;    top: 73%;    left: 51.5%;background-color:#4bc1d1;' name="" id="" class="in3" type="button" value="清空" onclick="cleanAll();"/>
